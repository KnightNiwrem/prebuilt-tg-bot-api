...
Run the official native Telegram Bot API server with Deno or Node. First
releases require the maintainer to provision the npm and JSR packages; these
commands become available after publication.
...
for supported platforms, compilation, permissions, and release details.
